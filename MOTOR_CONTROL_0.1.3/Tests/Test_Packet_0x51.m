...
assert(data_curr(8) == th, 'Failed, incorrect value on 8');
assert(data_curr(9) == nd, 'Failed, incorrect value on 9');
assert(ARDMODE == mode);

% Results
disp('Test_Packet_0x51 PASSED')